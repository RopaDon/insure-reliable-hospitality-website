        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mt-10 relative max-w-sm mx-auto flex flex-wrap justify-center gap-y-12 gap-x-6 sm:max-w-xl lg:max-w-none" data-aos-id-team>
            ...
            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={100}>
              ...
              <div className="font-medium text-blue-600">Co-Founder, Cheif Technology Operator</div>
            </div>

            <div className="text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]" data-aos-delay={200}>
              <div className="inline-flex mb-4">
                <Image className="rounded-full" src={Avatar} width={120} height={120} alt="Member 03" />
              </div>
              <h4 className="h4 font-playfair-display text-slate-800 mb-2">Javian Whyte</h4>
              <div className="font-medium text-blue-600">Co-Founder, Telemarketing Manager</div>
            </div>
          </div>
        </div>
      </div>
