        ...
        <div className="py-12 md:py-20">
          ...
          <div className="relative max-w-sm mx-auto grid gap-16 md:grid-cols-2 lg:grid-cols-3 lg:gap-y-20 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h3 className="h4 font-playfair-display mb-2">Comprehensive Solutions</h3>
              <p className="text-lg text-slate-500">We provide end-to-end contracting services, handling every aspect of the project from planning and execution to completion.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">Skilled Workforce</h3>
              <p className="text-lg text-slate-500">Our team consists of highly skilled professionals who excel in their respective fields.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">Customized Approach</h3>
              <p className="text-lg text-slate-500">We take the time to listen to your specific needs and tailor our solutions accordingly, delivering personalized outcomes that align with your vision.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="300">
              ...
              <h3 className="h4 font-playfair-display mb-2">Quality Craftsmanship</h3>
              <p className="text-lg text-slate-500">Our attention to detail, precision, and use of top-quality materials ensure the highest level of quality and durability.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="400">
              ...
              <h3 className="h4 font-playfair-display mb-2">Timely Project Delivery</h3>
              <p className="text-lg text-slate-500">Our efficient project management processes, combined with effective scheduling, enable us to complete projects within the agreed-upon timeframe.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
              ...
              <h3 className="h4 font-playfair-display mb-2">Exceptional Customer Service</h3>
              <p className="text-lg text-slate-500">We prioritize customer satisfaction and strive to exceed your expectations.</p>
            </div>
