...
import { PartnershipSchema } from "@/src/config/constants/schemas";
import WaitlistSuccess from "@/public/images/waitlist-success.png";
import { useRequestPartnershipMutation } from "@/src/redux/slices/api/service-slice";
                  ...
                  <form className="mt-8">
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          className={`form-input w-full ${errors.fullName && "border-rose-500"}`}
                          {...register("fullName", {
                            required: true,
                            maxLength: 80,
                          })}
                          required
                        />
                        <label className="block text-sm text-rose-500 mb-1 h-5" htmlFor="title">
                      ...
                      <div>
                        ...
                        <input
                          className={`form-input w-full ${errors.companyName && "border-rose-500"}`}
                          ...
                          required
                        />
                        <label className="block text-sm text-rose-500 mb-1 h-5" htmlFor="companyName">
                      ...
                      <div>
                        ...
                        <PhoneInput
                          ...
                          onChange={(number) => setValue("contactNumber", number)}
                          inputClass={`form-input w-full ${errors.contactNumber && "border-rose-500"}`}
                        />
                      ...
                      <div>
                        <label className="block text-sm font-medium mb-1" htmlFor="contactNumber">
                          Tell us a little bit about what you're looking for in this partnership <span className="text-rose-500">*</span>
                        </label>
                        ...
                        <textarea
                          ...
                          required
                        />
                        <label className="block text-sm text-rose-500 mb-1 h-5" htmlFor="partnershipDescription">
                          {errors.partnershipDescription?.message}
                        </label>
                      </div>
                    </div>
                    <div className="mt-6">
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6">
            <div className="w-full max-w-lg mx-auto">
              <h2 className="h3 md:text-4xl font-playfair-display text-slate-100 mb-4">Insure Reliable Hospitality</h2>
