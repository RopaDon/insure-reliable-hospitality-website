                ...
                <div className={`${category !== "1" && "hidden"}`}>
                  ...
                  <ul className="inline-flex flex-col space-y-6">
                    <li className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="text-gray-500">
                          Your talent solutions are designed to fit every budget, offering competitive pricing options that ensure affordability without
                    ...
                    <li className="flex items-start">
                      ...
                      <div>
                        <div className="font-cabinet-grotesk font-bold text-lg mb-1">Customized recruitment solutions</div>
                        <div className="text-gray-500">
                          Tailor your talent search to specific BPO roles and skill requirements, enabling you to find the perfect fit for your projects and
                          campaigns.
                        </div>
                      </div>
                    </li>
