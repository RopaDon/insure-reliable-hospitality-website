        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-md text-gray-600">
              Insure Reliable Hospitality embraces the transformative power of simplicity in international scaling. With our expertise, we recognize the
              intricate hurdles that arise when venturing into new markets. Therefore, our dedicated mission revolves around streamlining this process, ensuring
              a seamless and straightforward experience for you.
            </p>
          </div>
