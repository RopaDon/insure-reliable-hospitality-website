        ...
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400">
              As a BPO, we take pride in our unique and tailored approach to creating a custom-built ecosystem. We understand that every project is different
              and requires a specialized solution. That's why we have developed an ecosystem that is specifically designed to meet the diverse needs of our
              clients.
            </p>
          </div>
            ...
            <div className="relative flex justify-center items-center overflow-hidden">
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-purple-500 bg-gradient-to-tr from-purple-500 to-purple-400 dark:bg-purple-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-5 mt-80 top-4">
                  Virtual Workforce Optimization
                </div>
