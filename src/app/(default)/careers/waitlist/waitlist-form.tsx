...
import { CircularProgress, FormControl, FormControlLabel, FormLabel, RadioGroup } from "@mui/material";
import { yupResolver } from "@hookform/resolvers/yup";
import CountrySelect from "@/src/components/country-select";
import DisplayMessages from "@/src/config/constants/message";
import IndustrySelect from "@/src/components/industry-select";
import { WaitlistSchema } from "@/src/config/constants/schemas";
import WaitlistSuccess from "@/public/images/waitlist-success.png";
import JobExperienceSelect from "@/src/components/job-experience-select";
import { useCreateWaitlistUserMutation } from "@/src/redux/slices/api/waitlist-slice";
import AppRadio from "@/src/components/app-radio";
          ...
          <div className="px-5 pt-4 pb-1">
            <div className="text-sm">
              ...
              <div className="md:flex sm:items-center space-y-4 md:space-y-0 md:space-x-4 mt-4">
                <div className="w-full">
                  <label className="block text-sm font-medium mb-1" htmlFor="business-id">
                    Job Experience Level<span className="text-rose-500">*</span>
                  </label>
                  <JobExperienceSelect
              ...
              <FormControl sx={{ mt: 4 }}>
                <FormLabel>Do you have a stable internet connection?</FormLabel>
                <RadioGroup
                  aria-labelledby="demo-customized-radios"
                  {...register("hasSuitableInternet", {
                    required: true,
                    maxLength: 80,
                  })}
                >
                  <FormControlLabel value="true" control={<AppRadio />} label="Yes" />
                  <FormControlLabel value="false" control={<AppRadio />} label="No" />
                </RadioGroup>

                <label className="block text-sm text-rose-500 mb-1 h-5" htmlFor="hasSuitableInternet">
                  {errors.hasSuitableInternet?.message}
                </label>
              </FormControl>

              <FormControl sx={{ mt: 3 }}>
                <FormLabel>Are you equipped with a suitable device that enables you to perform your work efficiently?</FormLabel>
                <RadioGroup
                  aria-labelledby="demo-customized-radios"
                  {...register("hasSuitablelDevice", {
                    required: true,
                    maxLength: 80,
                  })}
                >
                ...
                <label className="block text-sm text-rose-500 mb-1 h-5" htmlFor="hasSuitablelDevice">
                  {errors.hasSuitablelDevice?.message}
                </label>
              </FormControl>
            </div>
          </div>
