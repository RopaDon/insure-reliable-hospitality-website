        ...
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400">
              As a contracting business, we take pride in our unique and tailored approach to creating a custom-built ecosystem. We understand that every
              project is different and requires a specialized solution. That's why we have developed an ecosystem that is specifically designed to meet the
