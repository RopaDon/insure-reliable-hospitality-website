          ...
          >
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-md text-slate-500">
                We provide end-to-end contracting services, handling every aspect of the project from planning and execution to completion.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
              ...
              <p className="text-md text-slate-500">Our team consists of highly skilled professionals who excel in their respective fields.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
              ...
              <p className="text-md text-slate-500">
                We take the time to listen to your specific needs and tailor our solutions accordingly, delivering personalized outcomes that align with your
                vision.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="300">
              ...
              <p className="text-md text-slate-500">
                Our attention to detail, precision, and use of top-quality materials ensure the highest level of quality and durability.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="400">
              ...
              <p className="text-md text-slate-500">
                Our efficient project management processes, combined with effective scheduling, enable us to complete projects within the agreed-upon timeframe.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
              ...
              <p className="text-md text-slate-500">We prioritize customer satisfaction and strive to exceed your expectations.</p>
            </div>
          </div>
        </div>
      </div>
