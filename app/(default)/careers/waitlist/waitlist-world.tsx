...
export default function WaitlistWorld() {
  ...
  const items: Item[] = [
    {
      ...
      name: "Javian Whyte",
      role: "Telemarketing",
      quote: "“ I feel grateful that IRH pushed me to expand my horizons and strive to accomplish more, not only in my career but in education as well.“",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-testimonialcar>
            <h2 className="h2 mb-4 text-white font-playfair-display" data-aos="fade-up" data-aos-anchor="[data-aos-id-testimonialcar]">
              Join the IRH waitlist
            </h2>
            <p className="text-base text-gray-400" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-testimonialcar]">
              Our waitlist is designed to keep you in the loop and ensure that you don't miss out on future opportunities. When all positions are currently
              filled, submitting your information to our waitlist will put you at the forefront of our consideration when new positions become available.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto pb-16">
            <ul className="flex flex-col sm:flex-row flex-wrap justify-center items-center text-lg text-gray-400 -mx-3 -my-2">
              <li className="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-testimonialcar]">
                ...
                <span className="text-base">Work Life Balance</span>
              </li>
              <li className="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-testimonialcar]">
                ...
                <span className="text-base">Competitive Salary And Equity</span>
              </li>
              <li className="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="600" data-aos-anchor="[data-aos-id-testimonialcar]">
                ...
                <span className="text-base">Career Growth Opportunities</span>
              </li>
              <li className="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="700" data-aos-anchor="[data-aos-id-testimonialcar]">
                ...
                <span className="text-base">Collaborative and Supportive Environment</span>
              </li>
              <li className="flex items-center mx-3 my-2" data-aos="fade-up" data-aos-delay="800" data-aos-anchor="[data-aos-id-testimonialcar]">
                ...
                <span className="text-base">Diversity and Inclusion</span>
              </li>
            </ul>
          </div>
                ...
                <div className="relative flex flex-col items-start" ref={testimonials}>
                  {items.map((item, index) => (
                    ...
                    >
                      ...
                      <blockquote className="text-base text-gray-400">{item.quote}</blockquote>
